...
BUILD_ARGS=-ldflags "-s -w -X github.com/timo-reymann/gitlab-ci-verify/pkg/buildinfo.GitSha=$(COMMIT_REF) -X github.com/timo-reymann/gitlab-ci-verify/pkg/buildinfo.Version=$(VERSION) -X github.com/timo-reymann/gitlab-ci-verify/pkg/buildinfo.BuildTime=$(NOW)"
