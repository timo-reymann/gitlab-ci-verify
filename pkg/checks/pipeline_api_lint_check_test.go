			...
			expectedFindings: []CheckFinding{
				{
					...
					Link:     "https://gitlab-ci-verify.timo-reymann.de/findings/GL-103.html",
					File:     ".gitlab-ci.yml",
				},
			},
		},
			...
			expectedFindings: []CheckFinding{
				{
					...
					Line:     -1,
					Message:  "this bad",
					Link:     "https://gitlab-ci-verify.timo-reymann.de/findings/GL-102.html",
					File:     ".gitlab-ci.yml",
				},
			},
		},
			...
			expectedFindings: []CheckFinding{
				{
					...
					Line:     -1,
					Message:  "this bad",
					Link:     "https://gitlab-ci-verify.timo-reymann.de/findings/GL-101.html",
					File:     ".gitlab-ci.yml",
				},
			},
		},
